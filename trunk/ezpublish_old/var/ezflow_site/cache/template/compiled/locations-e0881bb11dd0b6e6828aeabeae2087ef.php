...
$oldSetArray_d744f27712d15a59ca142af8d6aca01f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<tr>
    <th class="tight"><img src="/design/admin2/images/toggle-button-16x16.gif" alt="Invert selection." title="Invert selection." onclick="ezjs_toggleCheckboxes( document.locationsform, \'LocationIDSelection[]\' ); return false;"/></th>
...
$setArray = $oldSetArray_d744f27712d15a59ca142af8d6aca01f;
$tpl->Level--;
?>
