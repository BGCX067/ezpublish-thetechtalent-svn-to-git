...
$oldSetArray_128016a2b5474887f594aae8bad01ad0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="clearcacheform" method="post" action="/setup/cache">
...
<tr>
    <th class="tight"><img src="/design/admin2/images/toggle-button-16x16.gif" alt="Invert selection." onclick="ezjs_toggleCheckboxes( document.clearcacheform, \'CacheList[]\' ); return false;" title="Invert selection." /></th>
    <th>Name</th>
    <th>Path</th>
</tr>';
unset( $loopItem );
...
$setArray = $oldSetArray_128016a2b5474887f594aae8bad01ad0;
$tpl->Level--;
?>
