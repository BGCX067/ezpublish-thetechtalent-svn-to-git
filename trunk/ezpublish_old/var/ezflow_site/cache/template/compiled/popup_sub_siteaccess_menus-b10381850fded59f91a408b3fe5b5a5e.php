...
$oldSetArray_074182e9ec641331bea7018c5d7f8e1b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'siteAccessList', $rootNamespace ) )
{
  ...
  0 => 'ezflow_site_clean_user',
  1 => 'eng',
  2 => 'ezflow_site_clean_admin',
  3 => 'iphone',
), $rootNamespace );
}
else
...
$setArray = $oldSetArray_074182e9ec641331bea7018c5d7f8e1b;
$tpl->Level--;
?>
