...
$oldSetArray_89e6fdbb6a3ca8792fbb27a122b82eae = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ' title="Timeline"><img src="/extension/ezflow/design/ezflow/images/websitetoolbar/ezwt-icon-timeline.gif" alt="Timeline" /></a>';
}
unset( $if_cond );
// if ends


$setArray = $oldSetArray_89e6fdbb6a3ca8792fbb27a122b82eae;
$tpl->Level--;
?>
