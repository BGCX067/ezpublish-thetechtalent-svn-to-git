...
{def $keywords = array()}
{def $strKeywords = ''}
{foreach $current_node.data_map.tags.content.keywords as $key}
	{set $keywords= $keywords|append($key)}
{/foreach}
{set $strKeywords = $keywords|implode(', ')|wash()}

<meta name="keywords" content="{$strKeywords|trim()}"/>
<meta name="description" content="{$current_node.data_map.title.content|trim()}"/>   
<meta property="fb:app_id" content="180821115620"/>
...
<div id="page" class="{$pagestyle}">
	...
	<div id="fb-root"></div>
	<script>(function(d, s, id){literal}{{/literal}
	  var js, fjs = d.getElementsByTagName(s)[0];
	  if (d.getElementById(id)) return;
	  js = d.createElement(s); js.id = id;
	  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=180821115620";
	  fjs.parentNode.insertBefore(js, fjs);
	{literal}}{/literal}(document, 'script', 'facebook-jssdk'));</script>
