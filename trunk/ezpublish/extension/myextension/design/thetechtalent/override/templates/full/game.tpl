...
<div class="content-view-full">
    <div class="class-image">
        ...
        <div class="content-navigator">
            {if $previous_image}
                <div class="content-navigator-previous">
                    <div class="content-navigator-arrow">&laquo;&nbsp;</div><a href={$previous_image[0].url_alias|ezurl} title="{$previous_image[0].name|wash}">{'Previous gadget'|i18n( 'design/ezwebin/full/image' )}</a>
                </div>
            {else}
                <div class="content-navigator-previous-disabled">
                    <div class="content-navigator-arrow">&laquo;&nbsp;</div>{'Previous gadget'|i18n( 'design/ezwebin/full/image' )}
                </div>
            {/if}
            ...
            {if $next_image}
                <div class="content-navigator-next">
                    <a href={$next_image[0].url_alias|ezurl} title="{$next_image[0].name|wash}">{'Next gadget'|i18n( 'design/ezwebin/full/image' )}</a><div class="content-navigator-arrow">&nbsp;&raquo;</div>
                </div>
            {else}
                <div class="content-navigator-next-disabled">
                    {'Next gadget'|i18n( 'design/ezwebin/full/image' )}<div class="content-navigator-arrow">&nbsp;&raquo;</div>
                </div>
            {/if}
        ...
        <div class="attribute-image">
            <p>{*attribute_view_gui attribute=$node.data_map.image image_class=billboard*}
            {literal}
            <script src="{/literal}{$node.data_map.url.content}{literal}">
        ...
        <div class="fb-comments" data-href={$current_node.url|ezurl(,'full')} data-num-posts="20" data-width="770"></div>
