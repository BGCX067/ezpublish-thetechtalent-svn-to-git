...
$oldSetArray_de5a67184d3b08de981379c037b6e1bd = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
                    <img src="/design/standard/images/edit.gif" border="0" alt="Edit" />
                </a>
            </td>
        </tr>
    ';
...
$setArray = $oldSetArray_de5a67184d3b08de981379c037b6e1bd;
$tpl->Level--;
?>
