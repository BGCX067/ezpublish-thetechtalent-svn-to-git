...
$oldSetArray_b4165394910ad2d7feba8aa40e4ec7b0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<tr>
    <th class="tight"><img src="/design/admin2/images/toggle-button-16x16.gif" alt="Invert selection." title="Invert selection." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Language</th>
    <th>Locale</th>
...
$text .= '><img src="/design/standard/images/edit.gif" alt="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_b4165394910ad2d7feba8aa40e4ec7b0;
$tpl->Level--;
?>
