...
$oldSetArray_29508ad5ccdea0ad72304eb9d070a467 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ' title="Edit object states"><img src="/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-objectstates.gif" alt="Edit object states" /></a>';
}
unset( $if_cond );
// if ends


$setArray = $oldSetArray_29508ad5ccdea0ad72304eb9d070a467;
$tpl->Level--;
?>
