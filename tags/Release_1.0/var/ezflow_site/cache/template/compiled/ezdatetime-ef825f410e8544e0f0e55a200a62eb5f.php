...
// Filename:  design/admin2/templates/content/datatype/edit/ezdatetime.tpl
// Timestamp: 1285696602 (Tue Sep 28 10:56:42 MST 2010)
$oldSetArray_25bf9ba84714424e86ea691ea69247fe = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'base', $rootNamespace ) )
{
  ...
  2 => 'design/admin2/templates/content/datatype/edit/ezdatetime.tpl',
) );
    $tpl->setVariable( 'base', array (
  'yui3' => 'lib/yui/3.1.2/build/',
  'yui2' => 'lib/yui/2.8.1/build/',
), $rootNamespace );
}
else
{
...
(function() {    YUILoader.addModule({        name: \'datepicker\',
        type: \'js\',
        fullpath: \'/design/standard/javascript/ezdatepicker.js\',
        requires: ["calendar"],
        after: ["calendar"],
        skinnable: false
    });
...
<div class="element">
<img class="datepicker-icon" src="/design/admin2/images/calendar_icon.png" id="';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_base', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_base'] : null;
if (! isset( $var ) ) $var = NULL;
...
$setArray = $oldSetArray_25bf9ba84714424e86ea691ea69247fe;
$tpl->Level--;
?>
