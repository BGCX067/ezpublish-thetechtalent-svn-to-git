...
$oldSetArray_880902b5a55d6e6f959209477ef19d8b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
eZURI::transformURI( $var4, false, 'relative' );
$var4 = '"' . $var4 . '"';
$var3 = $var4;
unset( $var4 );
if (! isset( $var3 ) ) $var3 = NULL;
...
$text .= ' title="Up one level."><img src="/design/admin2/images/up-16x16-grey.png" alt="Up one level." title="Up one level." /></a>&nbsp;';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$text .= '" />
    ...
    ';
$oldRestoreIncludeArray_1e618516b62e2070daf1fdb7438c4a16 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezflow_site/cache/template/compiled/children_detailed-79d2d0fcc96b2f4a0813e8e389b32efc.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezflow_site/cache/template/compiled/children_detailed-79d2d0fcc96b2f4a0813e8e389b32efc.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_1e618516b62e2070daf1fdb7438c4a16;
...
$setArray = $oldSetArray_880902b5a55d6e6f959209477ef19d8b;
$tpl->Level--;
?>
